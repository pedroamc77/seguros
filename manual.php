                ...
                <div class="tab-content">
                  <!-- ORCINEA -->
                    <div id="orcinea" class="tab-pane fadein <?php echo $tab === '' || $tab === 'orci' ? ' show active' : '' ?>">
                      <form id="form_orci" action="manual.php" method="post">
                        ...
                        <div class="row justify-content-start align-items-center mb-1">
                          <label for="orci_fechai" class="col-sm-2 col-form-label ">Inicio: </label><div class="col-sm-4"><input required type="date" id="orci_fechai" name="orci_fechai" class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['orci_fechai'])   ? $_POST['orci_fechai']    : '' ?>"></div>
                          <label for="orci_fechaf" class="col-sm-2 col-form-label ">Final:  </label><div class="col-sm-4"><input required type="date" id="orci_fechaf" name="orci_fechaf" class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['orci_fechaf'])   ? $_POST['orci_fechaf']    : '' ?>"></div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="tab-content">
                              ...
                              <?php } ?>
                              <!-- <div id="orci_decl" class="tab-pane fadein">Declaración</div> -->
                              <div id="orci_empr" class="tab-pane fadein">
                                <form action="manual.php" id="frmPersona" method="POST" >
                                  <input type="hidden" name="nombres"    value="<?php echo isset($_POST['orci_nombres'])     ? $_POST['orci_nombres']   : '' ?>">
                                  <input type="hidden" name="apellidos"  value="<?php echo isset($_POST['orci_apellidos'])   ? $_POST['orci_apellidos'] : '' ?>">
                                  <input type="hidden" name="dni"        value="<?php echo isset($_POST['orci_dni'])         ? $_POST['orci_dni']       : '' ?>">
                  ...
                  <!-- HOST -->
                    <div id="host" class="tab-pane fade <?php echo $tab === 'host' ? ' show active' : '' ?>">
                      <form id="form_host" action="manual.php" method="post">
                        ...
                        <div class="row align-items-center mb-1">
                          ...
                          <label for="host_fechaf" class="col-sm-2 col-form-label">Final:  </label><div class="col-sm-4"><input required type="date" id="host_fechaf" name="host_fechaf" class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['host_fechaf'])   ? $_POST['host_fechaf']    : '' ?>"></div>
                        </div>
                        <div class="row justify-content-start align-items-center mb-1 me-1">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="tab-content">
                                  ...
                                  <form id="form_host_bol" action="reportes/boletadepago<?php echo $bo['host'] ?>.php" method="post" target="_blank" >
                                    ...
                                    <div class="row">
                                      <div class="col-6">
                                        ...
                                        <div class="row mb-1">
                                          <label for="sueldo" class="col-5 col-form-label">REM. VACACIONAL:</label>
                                          <div class="col-7">
                                            <input onkeypress="return filterFloat(event,this);" type="text" id="remvacacionales" name="remvacacionales" class="form-control form-control-sm" value="<?php echo isset($_POST['remvacacionales']) ? $_POST['remvacacionales'] : '0' ?>">
                                          </div>
                                        </div>
                              ...
                              <?php } ?>
                              <!-- <div id="host_decl" class="tab-pane fadein">Declaración</div> -->
                  ...
                  <!-- REFLEX -->
                    <div id="reflex" class="tab-pane fade <?php echo $tab === 'refl' ? ' show active' : '' ?>">
                      <form id="form_host" action="manual.php" method="post">
                        ...
                        <!-- <div class="row align-items-center mb-1"><label for="refl_nombres"    class="col-sm-2 col-form-label">Nombres:  </label><div class="col-sm-10"> -->
                          <input readonly type="hidden" id="refl_nombres"   name="refl_nombres"   class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['orci_nombres'])   ? $_POST['orci_nombres']    : '' ?>">
                        <!-- </div></div> -->
                        <!-- <div class="row align-items-center mb-1"><label for="refl_apellidos"  class="col-sm-2 col-form-label">Apellidos:</label><div class="col-sm-10"> -->
                          <input readonly type="hidden" id="refl_apellidos" name="refl_apellidos" class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['orci_apellidos']) ? $_POST['orci_apellidos']  : '' ?>">
                        <!-- </div></div> -->
                        <!-- <div class="row align-items-center mb-1"><label for="refl_dni"        class="col-sm-2 col-form-label">D.N.I.:   </label><div class="col-sm-10"> -->
                          <input readonly type="hidden" id="refl_dni"       name="refl_dni"       class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['orci_dni'])       ? $_POST['orci_dni']        : '' ?>">
                        <!-- </div></div> -->
                        <!-- <div class="row align-items-center mb-1"><label for="refl_empresa"    class="col-sm-2 col-form-label">Empresa:  </label><div class="col-sm-10"> -->
                          <input type="hidden" id="refl_empresa"   name="refl_empresa"   class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['refl_empresa'])   ? $_POST['refl_empresa']    : '' ?>">
                        <!-- </div></div> -->
                        <!-- <div class="row align-items-center mb-1"><label for="refl_emprdni"    class="col-sm-2 col-form-label">R.U.C.:   </label><div class="col-sm-7"> -->
                          <input type="hidden" id="refl_emprdni"   name="refl_emprdni"   class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['refl_emprdni'])   ? $_POST['refl_emprdni']    : '' ?>">
                        <!-- </div> -->
                        <!-- <div class="col-sm-3"><button class="btn btn-primary btn-sm" type="button" onclick="obtenerEmpresa('refl')">Buscar</button></div></div> -->
                        <div class="row align-items-center mb-1">
                          ...
                          <label for="refl_fechaf" class="col-sm-2 col-form-label">Final:  </label><div class="col-sm-4"><input required type="date" id="refl_fechaf" name="refl_fechaf" class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['refl_fechaf'])   ? $_POST['refl_fechaf']    : '' ?>"></div>
                        </div>
                        <div class="row justify-content-start align-items-center mb-1 me-1">
                          <!-- <label for="refl_cargo"      class="col-sm-2 col-form-label">Cargo:    </label> -->
                          <div class="col-sm-8">
                            <input type="hidden" id="refl_cargo"     name="refl_cargo"     class="form-control form-control-sm" placeholder="" value="<?php echo isset($_POST['refl_cargo'])     ? $_POST['refl_cargo']      : '' ?>">
                          </div>
                          <button type="submit" class="col-2 btn btn-light btn-sm">Cargar</button>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="tab-content">
                              ...
                              <?php } ?>
                              <!-- <div id="refl_decl" class="tab-pane fadein">Declaración</div> -->
            ...
            <!-- <div class="col-4"> -->
              <?php
                if ( isset($_POST['finicio']) && isset($_POST['ffinal']) ) {
                  ...
                  // $fi = date_create($_POST['finicio']);
                  // $ff = date_create($_POST['ffinal']);
                  // $df = date_diff($ff, $fi);
                  ...
                  // $fai = date_create(date_format($ff, "Y-m-d"));
                  // $fai = date_add($fai,  date_interval_create_from_date_string($mese." months"));
                  // $fai = date_add($fai,  date_interval_create_from_date_string($dias." days"));
                  
                  // $faf = date_create(date_format($fai, "Y-m-d"));
                  // $faf = date_add($faf,  date_interval_create_from_date_string($años." years"));
                  // $faf = date_add($faf,  date_interval_create_from_date_string($mese." months"));
                  // $faf = date_add($faf,  date_interval_create_from_date_string($dias." days"));
                  
                  // $maa = date_format($fai , "n");
                  // $datos['fechas']['fa1'] = date_format($fai, "j").' de '.$meses[$maa].' de '.date_format($fai , "Y"); 
                  // $datos['fechas']['fa2'] = date_format($fai, "d.m.Y"); 
                  // $datos['fechas']['fa3'] = date_format($fai, "Y-m-d");
                  // $datos['fechas']['fa4'] = date_format($fai, "j").'.'.$mes[$maa].'.'.date_format($fai , "Y"); 

                  // $datos['fechas']['fb1'] = date_format($faf, 'j').' de '.$meses[date_format($faf , "n")].' de '.date_format($faf , "Y"); 
                  // $datos['fechas']['fb2'] = date_format($faf, "d.m.Y"); 
                  // $datos['fechas']['fb3'] = date_format($faf, "Y-m-d");
                  // $datos['fechas']['fb4'] = date_format($faf, 'j').'.'.$mes[date_format($faf , "n")].'.'.date_format($faf , "Y"); 
                  
                  // $emisiona_b = date_create(date_format($faf, "d.m.Y"));
                  // $emisiona_b = date_add($emisiona_b, date_interval_create_from_date_string("7 days"));
                  
                  // $datos['fechas']['emision'] = date_format($emisiona_b, "d.m.Y"); 
                  // $datos['fechas']['anniorep'] = date_format($faf, "Y");
                  
                  // $empresas = empresa_cotizada(date_format($fai, "Y-m-d"), date_format($faf, "Y-m-d"));
                  $valido = false;
                  do {
                    $aniosa = rand(9, 11);
                    $aniosb = rand(9, 11);
                  ...
                  $datos['fechas'] = generar_fechas_trabajo(array("0000-00-00", $aniosa, $aniosb, $daysint, $monthsint, $aniosint), true, $_POST['ffinal']);
                          ...
                          <div class="column-reverse">
                            <div class="col">
                                  ...
                                  <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                      <button class="nav-link active" id="certificado_<?php echo $numemp ?>-tab" data-bs-toggle="pill" data-bs-target="#certificado_<?php echo $numemp ?>" type="button" role="tab"   aria-controls="certificado_<?php echo $numemp ?>" aria-selected="true">Certificado1</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                  ...
                                  <?php
                                    for ( $p = 1 ; $p < 4 ; $p++ ) {
                                      ...
                                      if ( $bonoactivo && $numemp === 2 && $anniorp = 1994 ) {
                                        $rep = "bono";
                                        $dec = rand(1, 3);
                                        echo "<div class='tab-pane fade capitalizar' id='".$rep."_".$numemp."' role='tabpanel' aria-labelledby='".$rep."_".$numemp."-tab'>";
                            ...
                            <div class="col">
                              <?php
                                  ...
                                  if ( count($datos) ) {
                                    ...
                                    $febi = date_create($datos['fechas']['fa3']);
                                    $febf = date_create($datos['fechas']['fb3']);
