...
$total_deven = $incentivo+$bonificacion;
...
$totalpago = ($totalsueldo+$total_deven)-($total_deduc+$retencion)
...
?>
    <div class="pagina_liq" >
        <div class="liquidacion6272">
            ...
            <?php if ($adelanto)       { echo "<div class='liq6272_tcalculo'>IV Adelanto:      <strong class='resaltar'>(&nbsp;S/.",nf($adelanto)       ," )</strong></div>"; } ?>
            <?php if ($incentivo)      { echo "<div class='liq6272_tcalculo'>V Incentivo:      <strong class='resaltar'>&nbsp;S/.",nf($incentivo)      ," </strong></div>"; } ?>
            <?php if ($bonificacion)   { echo "<div class='liq6272_tcalculo'>VI Bonificación:  <strong class='resaltar'>&nbsp;S/.",nf($bonificacion)   ," </strong></div>"; } ?>
            <?php if ($retencion)      { echo "<div class='liq6272_tcalculo'>VII Retención:    <strong class='resaltar'>(&nbsp;S/.",nf($retencion)     ," )</strong></div>"; } ?>
