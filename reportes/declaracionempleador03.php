...
<body>
    <div class="pagina_decl" >
        <div class="declaracion">
            ...
            <div class="decl">
                <div style="width: content">Por la presente, yo </div><div class="divLinea truncar" style="width: 350px"><?php echo $_POST['rep_legal'] ?></div><div style="width: content">, identificado con </div><div class="divLinea" style="width: 160px"><?php echo $_POST['dni_a'] ?></div>
                <div style="width: content">en calidad de Representante Legal de la Empresa </div><div class="divLinea truncar" style="width: 430px"><?php echo $_POST['empresa'] ?></div>
                <div style="width: content">identificada con Registro Único de Contribuyente - R.U.C. - N° </div><div class="divLinea" style="width: 133px"><?php echo $_POST['ruc'] ?></div><div style="width: content">. Declaro bajo juramento que el señor(a)</div>
                <div class="divLinea" style="width: 400px"><?php echo $_POST['apellidos'],", ",$_POST['nombres'] ?></div><div style="width: content">, identificado con </div><div class="divLinea" style="width: 215px"><?php echo $_POST['dni'] ?></div>,
                <div style="width: content">código ESSALUD N° </div><div class="divLinea" style="width: 190px"></div><div style="width: content"> y Código Único del SPP (CUSPP) N° </div><div class="divLinea" style="width: 205px"><?php echo $_POST['numautog'] ?></div>
            ...
            <!-- <p>
                Por la presente, yo ________________________________________, identificado con _____________________________________
