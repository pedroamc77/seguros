    ...
    <div class="pagina_bol" >
        <div class="boleta7880">
            <div class="marco_cubre">
                ...
                <div class="marco_linea9 mayusculas">
                    <div>reg. prest. salud 3%&nbsp;</div><div>&nbsp;<?php echo number_format($traipss,2,",",".") ?></div><div>&nbsp;</div><div>&nbsp;</div>
                </div>
                <div class="marco_linea9 mayusculas">
                    <div>sist. nac. pensiones 3%&nbsp;</div><div>&nbsp;<?php echo number_format($trasnp,2,",",".") ?></div><div>&nbsp;</div><div>&nbsp;</div>
                </div>
                <div class="marco_linea9 mayusculas">
                ...
                <div class="marco_linea9 mayusculas">
                    <div>fonavi 3%&nbsp;</div><div>&nbsp;<?php echo number_format($trafonavi,2,",",".") ?></div><div>&nbsp;</div><div>&nbsp;</div>
                </div>
                <div class="marco_linea9 mayusculas">
                ...
                <div class="marco_linea10 mayusculas">
                    <div>total desduentos S/.&nbsp;</div><div>&nbsp;<?php echo number_format($tratotaldeduc,2,",",".") ?></div><div>&nbsp;</div><div>&nbsp;</div>
                </div>
